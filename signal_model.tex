...
deflection as caused by activation from the guitar pick. The string has initial displacement $\delta$ at the plucking position $P$. %At release the vibrating string has length $L$
