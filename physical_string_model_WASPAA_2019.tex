...
%the well-known partial-differential equation for an ideal string (also known as the 1D wave-equation)
...
\begin{equation}\label{eq:tensile_stress}
   ...
   %= \frac{T_0/A_\text{c}}{\Delta L/(L_0 - \Delta L)} 
...
%
%
\subsection{Calculating effective Young's Modulus $E_\text{eff}$}%Calculating strain length $\Delta L$ from material properties}
%
